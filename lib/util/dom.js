(function (global, factory) {
     ...
     * @return {HTMLElement} 目标元素
     */
    function toggleClass(element, className, isForce) {
        isForce = 'boolean' === typeof isForce ? isForce : !exports.hasClass(element, className);
     ...
     * @return {Object}
     */
    function position(element, offsetEle) {
        var res = {};
        ...
        if (offsetEle) {
            ...
            res.left = pos.left + Math.max(document.documentElement.scrollLeft, document.body.scrollLeft);
            res.top = pos.top + Math.max(document.documentElement.scrollTop, document.body.scrollTop);
        }
